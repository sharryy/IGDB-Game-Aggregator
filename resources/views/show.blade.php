        ...
        <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
            ...
            <div class="lg:ml-12 lg:mr-64">
                ...
                <div class="text-gray-400 mt-2">
                    ...
                    &middot;
                    <span>{{ $games['involvedCompanies'] }}</span>
                    &middot;
                    <span>
                        {{ $games['platforms'] }}
                    </span>
                ...
                <div class="flex flex-wrap items-center mt-8">
                    ...
                    <div class="flex items-center space-x-4 mt-4 lg:mt-0 lg:ml-12">
                        @if($games['social']['website'])
                            <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                                <a href="{{ $games['social']['website']['url'] }}" class="hover:text-gray-400">
                        ...
                        @if($games['social']['instagram'])
                            <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                                <a href="{{ $games['social']['instagram']['url'] }}" class="hover:text-gray-400">
                        ...
                        @if($games['social']['twitter'])
                            <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                                <a href="{{ $games['social']['twitter']['url'] }}" class="hover:text-gray-400">
                        ...
                        @if($games['social']['facebook'])
                            <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                                <a href="{{ $games['social']['facebook']['url'] }}" class="hover:text-gray-400">
                        ...
                        <div class="container mx-auto lg:px-32 rounded-lg overflow-y-auto">
                            <div class="bg-gray-900 rounded">
                                <div class="flex justify-end pr-4 pt-2">
                                    <button
                                        x-on:click="isTrailerModalVisible = false"
