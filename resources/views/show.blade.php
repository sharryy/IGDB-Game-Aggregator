    ...
    <div class="container mx-auto px-4">
                ...
                <div class="flex flex-wrap items-center mt-8">
                    ...
                    <div class="flex items-center space-x-4 mt-4 lg:mt-0 lg:ml-12">
                        ...
                        @if($games['social']['twitter'])
                            <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                                <a href="{{ $games['social']['twitterg']['url'] }}" class="hover:text-gray-400">
        ...
        <div class="similar-games-container mt-8">
            ...
            <div
                ...
                @foreach($games['similarGames'] as $sim_games)
                    <div class="game mt-8">
                        <div class="relative inline-block">
                            <a href="#">
                                <img src="{{ $sim_games['coverImageUrl'] }}"
                                     alt="game cover"
                                     class="hover:opacity-75 transition ease-in-out duration-150">
                            </a>
                            @if($sim_games['rating'])
